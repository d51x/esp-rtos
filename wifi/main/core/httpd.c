...
void register_uri_handlers(httpd_handle_t _server) {
    ...
    add_uri_get_handler( _server, "/i2cscan", i2cscan_get_handler); 
    ...
    add_uri_get_handler( _server, "/menu.png", icons_get_handler); 
    add_uri_get_handler( _server, "/menu2.png", icons_get_handler); 
